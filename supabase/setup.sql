...
-- Historical monthly attendance tallies (past months where only a per-month
-- count is known, not the individual dates). Current months are tracked
-- per-service in attendance_records and totalled automatically.
